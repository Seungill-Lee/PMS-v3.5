...
function initGNB() {
	...
	gDeps1.find(">a").on("click",function(e) {
	...
	gDeps2.find(">a").on("click",function(e) {
	...
	$("nav#gnb,main#container,header#header>h1,#header>#g_utile,#header>button.btn_sitemap").on("click",function() {
		gDeps1.find(">a").removeClass("active");
		gDeps1.find(">ul").hide();
		gDeps2.find(">a").removeClass("active");
		gDeps2.find(">ul").hide();
